...
SNPs_notLD_epistasis=data.frame(SNPs_notLD_epistasis$SNP_A, SNPs_notLD_epistasis$SNP_B, SNPs_notLD_epistasis$pval)
colnames(SNPs_notLD_epistasis)=c("SNP_A","SNP_B", "pval_adj")
SNPs_notLD_epistasis=SNPs_notLD_epistasis[SNPs_notLD_epistasis$pval_adj<=10^(-5),]
